...
export const strings = {
  en: {
    ...
    handmade: {
      ...
      paragraphs: [
        'Every clock is built by hand with precision. The first run is limited to just 100 pieces. This series is intentionally open-ended:',
  ...
  de: {
    ...
    whatIs: {
      ...
      paragraphs: [
        ...
        'Handgefertigt aus echtem Glas, bestückt mit 576 RGB-LEDs und viel Liebe zum Detail. Jede Uhr wird zu einem Unikat, mit Charakter, Ausdruck und handwerklicher Präzision.',
      ],
