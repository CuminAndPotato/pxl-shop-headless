...
export const FRESH_LAYOUT_SLUGS = [
  'plus7', 'plus6', 'plus5', 'plus4', 'plus3', 'plus2', 'plus',
  ...
  },
  {
    ...
    copy: {
      en: {
        name: 'Original Plus⁷',
        shortName: 'Plus⁷',
        thesis: 'Story arc "Pixel by Pixel" — the PXL Clock told from a maker / programmability angle: one pixel, 576 pixels, then a clock, then a stage, then a community.',
        introEyebrow: 'Story · Pixel by Pixel',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Scroll-driven product story. Six chapters that frame the clock as a programmable canvas — written in C#, shared on NuGet, hacked on at PXL-JAM.',
        bullets: ['Six chapter story arc', 'Maker / code angle', 'Same scroll choreography as Plus⁵'],
        note: 'Alternative narrative #3 — for readers who care about how it works under the hood.',
        quote: { line1: 'It starts with one pixel.', line2: 'It ends with a community.' },
      },
      de: {
        name: 'Original Plus⁷',
        shortName: 'Plus⁷',
        thesis: 'Story-Arc "Pixel by Pixel" — die PXL Clock aus der Maker- / Programmability-Perspektive erzählt: ein Pixel, 576 Pixel, dann eine Uhr, dann eine Bühne, dann eine Community.',
        introEyebrow: 'Story · Pixel by Pixel',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Scroll-getriebene Produkt-Story. Sechs Kapitel, die die Uhr als programmierbare Leinwand framen — geschrieben in C#, geteilt auf NuGet, gehackt am PXL-JAM.',
        bullets: ['Sechs-Kapitel-Story', 'Maker / Code-Winkel', 'Gleiche Scroll-Choreographie wie Plus⁵'],
        note: 'Alternative-Erzählung #3 — für Leser, die wissen wollen, wie es unter der Haube funktioniert.',
        quote: { line1: 'Es beginnt mit einem Pixel.', line2: 'Es endet mit einer Community.' },
      },
    },
  },
  {
    ...
    copy: {
      en: {
        name: 'Original Plus⁶',
        shortName: 'Plus⁶',
        thesis: 'Story arc "A day in your room" — six chapters take the PXL Clock through the hours of the day: dawn, morning, midday, late afternoon, evening, night.',
        introEyebrow: 'Story · A day with the clock',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Scroll-driven product story. Six time-of-day scenes frame the clock as a living presence in the room — from sleepy blue mornings to contemplative nights.',
        bullets: ['Six chapter story arc', 'Time-of-day atmosphere', 'Same scroll choreography as Plus⁵'],
        note: 'Alternative narrative #2 — for readers who think in scenes rather than features.',
        quote: { line1: 'A clock has 24 moods.', line2: 'Not just two hands.' },
      },
      de: {
        name: 'Original Plus⁶',
        shortName: 'Plus⁶',
        thesis: 'Story-Arc "Ein Tag in deinem Zimmer" — sechs Kapitel nehmen die PXL Clock durch die Stunden des Tages mit: Morgendämmerung, Vormittag, Mittag, Spätnachmittag, Abend, Nacht.',
        introEyebrow: 'Story · Ein Tag mit der Uhr',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Scroll-getriebene Produkt-Story. Sechs Tageszeiten-Szenen rahmen die Uhr als lebendige Präsenz im Raum — vom verschlafenen blauen Morgen bis zur nachdenklichen Nacht.',
        bullets: ['Sechs-Kapitel-Story', 'Tageszeit-Atmosphäre', 'Gleiche Scroll-Choreographie wie Plus⁵'],
        note: 'Alternative-Erzählung #2 — für Leser, die in Szenen statt in Features denken.',
        quote: { line1: 'Eine Uhr hat 24 Stimmungen.', line2: 'Nicht nur zwei Zeiger.' },
      },
    },
  },
  {
    ...
    copy: {
      en: {
        name: 'Original Plus⁵',
        shortName: 'Plus⁵',
        thesis: 'Story arc "What it actually is" — six chapters explain the PXL Clock by widening the definition: it is a clock, also a sculpture, also a storyteller, also a thinker, also a piece of furniture.',
        introEyebrow: 'Story · What it is',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Scroll-driven product story. Six chapters walk you from "obviously a clock" outwards through everything else the PXL Clock can be at the same time.',
        bullets: ['Six chapter story arc', 'Plain-spoken / journalistic', 'Same scroll choreography on all three variants'],
        note: 'Alternative narrative #1 — the user-suggested framing. Reads like a small product manifesto.',
        quote: { line1: 'A clock, yes.', line2: 'And four other things too.' },
      },
      de: {
        name: 'Original Plus⁵',
        shortName: 'Plus⁵',
        thesis: 'Story-Arc "Was sie alles ist" — sechs Kapitel erklären die PXL Clock, indem sie die Definition weit aufmachen: sie ist eine Uhr, auch eine Skulptur, auch ein Geschichtenerzähler, auch ein Denker, auch ein Möbelstück.',
        introEyebrow: 'Story · Was sie ist',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Scroll-getriebene Produkt-Story. Sechs Kapitel führen vom "ist offensichtlich eine Uhr" nach außen — durch alles, was die PXL Clock gleichzeitig sein kann.',
        bullets: ['Sechs-Kapitel-Story', 'Sachlich / journalistisch', 'Gleiche Scroll-Choreographie auf allen drei Varianten'],
        note: 'Alternative-Erzählung #1 — der vom User vorgeschlagene Rahmen. Liest sich wie ein kleines Produkt-Manifest.',
        quote: { line1: 'Eine Uhr, ja.', line2: 'Und vier andere Dinge auch.' },
      },
    },
  },
  {
