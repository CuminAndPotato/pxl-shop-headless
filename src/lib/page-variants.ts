  ...
  },
  {
    ...
    copy: {
      en: {
        name: 'Original Plus⁵',
        shortName: 'Plus⁵',
        thesis: 'Scroll-driven product page with FIVE switchable story arcs (definition, daily, campfire, diva, maker). Each story runs the same pinned-hero choreography but pairs different chapter copy with different pixograms. Story selector lives in a floating top-center panel.',
        introEyebrow: 'Story sandbox',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Five product-story arcs share one scroll choreography. Pick one in the top panel, the page reloads with that story\'s chapters + pixograms wired up. Same LED projection framework, same tweak panel.',
        bullets: ['Five switchable narratives', 'Custom + community pixograms', 'CTA chapter per story'],
        note: 'Single page consolidates the previous Plus⁵/⁶/⁷ experiment — story arc is now a runtime setting, not a separate URL.',
        quote: { line1: 'Five stories.', line2: 'One product. One clock.' },
      },
      de: {
        name: 'Original Plus⁵',
        shortName: 'Plus⁵',
        thesis: 'Scroll-getriebene Produktseite mit FÜNF umschaltbaren Story-Arcs (Definition, Tagesablauf, Lagerfeuer, Diva, Maker). Alle Stories nutzen die gleiche Pinned-Hero-Choreographie, koppeln aber unterschiedliche Kapiteltexte an unterschiedliche Pixogramme. Story-Auswahl im fliegenden Top-Center-Panel.',
        introEyebrow: 'Story-Sandbox',
        introTitle: ['Time.', 'Design.', 'Expression.'],
        introLead: 'Fünf Produkt-Stories teilen sich eine Scroll-Choreographie. Wähle eine im Top-Panel, die Seite lädt mit den entsprechenden Kapiteln + Pixogrammen neu. Selbes LED-Framework, selbes Tweak-Panel.',
        bullets: ['Fünf umschaltbare Erzählungen', 'Eigene + Community-Pixogramme', 'CTA-Kapitel pro Story'],
        note: 'Eine Seite konsolidiert die vorherigen Plus⁵/⁶/⁷-Experimente — der Story-Arc ist jetzt eine Runtime-Einstellung, keine separate URL.',
        quote: { line1: 'Fünf Stories.', line2: 'Ein Produkt. Eine Uhr.' },
      },
    },
  },
  {
